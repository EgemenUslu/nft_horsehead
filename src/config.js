...
export const FirstNineMHSBacgroundColors = [
  "Orange",
  "Maroon",
  "Maroon",
  "Yellow",
...
export const SMALL_IMAGE_BASE_URL =
  "QmVkkNVhWjsF9urhFykcHwWVKudfVGh7JujUxVjbtcaStc";

export const SMALL_IMAGE_URL_FIRST_HALF = (nft_no) =>
  `https://ipfs.io/ipfs/bafybeihza43cwj6ekpkbc46rq7ycey737o55jrnydnakueopehcxi5bdjq/${nft_no}%20(x800).png`;

export const SMALL_IMAGE_URL_SECOND_HALF = (nft_no) =>
  `https://ipfs.io/ipfs/bafybeiccfenru42gsj237lrmqn7swfz3vdyw7lmyabndlegcl7vaa6we24/${nft_no}%20(x800).png`;

export const SMALL_IMAGE_URL = (nft_no) =>
  nft_no > 5000
    ? SMALL_IMAGE_URL_SECOND_HALF(nft_no)
    : SMALL_IMAGE_URL_FIRST_HALF(nft_no);

export const HERO_NFTS = [25, 2349, 2323, 9436, 171, 6143, 6, 1148];

export const COLOR_FOR_HERO = (type, id) =>
  type === "background"
    ? BackgroundColorMap[
        Metadata[HERO_NFTS[id] - 1]["attributes"]["1. Backgrounds"][0]
      ]
    : type === "text"
    ? ModalTextColorMap[
        Metadata[HERO_NFTS[id] - 1]["attributes"]["1. Backgrounds"][0]
